...
<html lang="de">
<head>
  <title>JF Pavimenti | Design RoyalSpace 16</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="JF Pavimenti | Produkte | Designbeläge | Design RoyalSpace 16">
  <!-- Favicons -->
      ...
      <div class="content">
        ...
        <div class="dropdown dactive">
          ...
          <div>
            ...
            <a href="../../designbelag/design-royalspace-16/raumbilder.php" class="lactive">Design RoyalSpace 16</a>
        ...
        <div class="dropdown">
          ...
          <div>
            ...
            <a href="../../teppichboden/trend15/raumbilder.php">Trend15</a>
          </div>
        </div>
      </div>
    </section>
    <section class="wrapper-white3" id="choose">
      <div class="content">
        <a href="raumbilder.php#choose" class="first">Raumbilder</a>
        <a href="flaechenbilder.php#choose" class="sactive">Flächenbilder</a>
      </div>
    </section>
    <section class="wrapper-white4">
      <div class="content gallery flaeche">
<?php
  foreach (glob('flaechenbilder/thumbnails/*.jpg') as $thumb) {
    $name = basename($thumb);
    $rawname = basename($thumb,'.jpg');
    $large = 'flaechenbilder/'.$name;
    list($width, $height) = getimagesize($large);
    echo '
<figure class="fl-fig">
  <a href="'.$large.'" data-size="'.$width.'x'.$height.'">
    <img src="'.$thumb.'" class="fl-thumb">
  </a>
  <figcaption>';
include 'flaechenbilder/infos/'.$rawname.'.php';
    echo '
  </figcaption>
</figure>';
  }
