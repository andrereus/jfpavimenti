...
<html lang="de">
<head>
  <title>JF Pavimenti | Calgary 2.5 LDX</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="JF Pavimenti | Produkte | Parkettböden | Calgary 2.5 LDX">
  <!-- Favicons -->
    ...
    <section class="wrapper-white2">
      <div class="content">
        <div class="dropdown dactive">
          ...
          <div>
            <a href="../../parkettboden/calgary-25-ldx/raumbilder.php" class="lactive">Calgary 2.5 LDX</a>
