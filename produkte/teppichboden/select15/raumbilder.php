...
<html lang="de">
<head>
  <title>JF Pavimenti | Select15</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta name="description" content="JF Pavimenti | Produkte | Teppichböden | Select15">
  <!-- Favicons -->
    ...
    <section class="wrapper-white2">
      <div class="content">
        ...
        <div class="dropdown dactive">
          ...
          <div>
            <a href="../../teppichboden/select15/raumbilder.php" class="lactive">Select15</a>
